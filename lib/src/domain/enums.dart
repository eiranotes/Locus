...
extension ObjectKindLabel on ObjectKind {
  String get labelKo => switch (this) {
    ...
    ObjectKind.mailbox => '우편함',
    ObjectKind.rainShelter => '비 가림막',
    ObjectKind.stoneGate => '돌문',
    ObjectKind.clockPost => '골목 시계',
    ObjectKind.bookKiosk => '책 가판대',
    ObjectKind.laundryLine => '빨랫줄',
    ObjectKind.flowerArch => '꽃 아치',
    ObjectKind.birdBath => '새 목욕대',
    ObjectKind.greenhouse => '온실',
    ObjectKind.fountain => '작은 분수',
    ObjectKind.picnicTable => '피크닉 탁자',
    ObjectKind.willow => '버드나무',
    ObjectKind.lanternString => '전구 줄',
    ObjectKind.windChime => '풍경',
    ObjectKind.teaTable => '찻상',
    ObjectKind.marketStall => '밤 장터',
    ObjectKind.stoneLantern => '석등',
    ObjectKind.observatory => '별 관측대',
  };
}
