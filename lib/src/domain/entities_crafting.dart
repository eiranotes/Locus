...
class StepBucket {
  ...
  int get available =>
      (observedSteps - spentSteps).clamp(0, 1 << 31).toInt();
...
class Footprint {
  ...
  factory Footprint.fromJson(Map<String, Object?> json) => Footprint(
  ...
  factory RecipeDefinition.fromJson(Map<String, Object?> json) {
    ...
    return RecipeDefinition(
      ...
      baseEffects: rawEffects.map(
        (String key, Object? value) => MapEntry<String, int>(key, value! as int),
      ),
    );
  }
}
